  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-50 p-4">
      <div className="bg-gray-800 w-full max-w-lg p-6 rounded-lg shadow-2xl text-center border-2 border-yellow-400">
        <h2 className="text-3xl font-bold mb-6">Ask the Audience</h2>
        ...
        <button onClick={onClose} className="mt-8 bg-yellow-500 text-black font-bold py-2 px-8 rounded-full hover:bg-yellow-400">
          Close
        </button>
      </div>
    </div>
