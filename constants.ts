...
export const PRIZE_LADDER: Prize[] = [
  { level: 15, prize: '₦50,000,000', title: 'Cybersecurity Millionaire', isSafeZone: false },
  { level: 14, prize: '₦35,000,000', title: '', isSafeZone: false },
  { level: 13, prize: '₦25,000,000', title: 'Security Champion', isSafeZone: false },
  { level: 12, prize: '₦15,000,000', title: '', isSafeZone: false },
  { level: 11, prize: '₦10,000,000', title: '', isSafeZone: false },
  { level: 10, prize: '₦5,000,000', title: 'Data Defender', isSafeZone: true },
  { level: 9, prize: '₦2,000,000', title: '', isSafeZone: false },
  { level: 8, prize: '₦1,000,000', title: '', isSafeZone: false },
  { level: 7, prize: '₦750,000', title: '', isSafeZone: false },
  { level: 6, prize: '₦500,000', title: '', isSafeZone: false },
  { level: 5, prize: '₦250,000', title: 'Phish Fighter', isSafeZone: true },
  { level: 4, prize: '₦200,000', title: '', isSafeZone: false },
  { level: 3, prize: '₦150,000', title: '', isSafeZone: false },
  { level: 2, prize: '₦100,000', title: '', isSafeZone: false },
  { level: 1, prize: '₦50,000', title: 'Cyber Smart Starter', isSafeZone: false },
];
